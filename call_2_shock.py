...
w = 5
time_to_maturity = [120 for j in range(n_corporates)]
discount_rate = 0.2
beta = 0.8
delta = [np.random.triangular(0.2,0.5,0.8) for j in range(n_investors)] #0.3,0.5,0.7 #0.4,0.6,0.8 #0.1,0.2,0.3
mi = [np.random.triangular(0.15,0.2,0.25) for j in range(n_investors)]
sigma = [np.random.triangular(0.1,0.2,0.3) for j in range(n_investors)]
gamma = 0.6
