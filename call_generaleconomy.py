...
mi = [np.random.triangular(0.015,0.020,0.025) for j in range(n_investors)] #0.15,0.2,0.25 #0.015,0.020,0.025
sigma = [np.random.triangular(0.1,0.15,0.20) for j in range(n_investors)] #0.2, 0.3, 0.4 #0.1,0.15,0.20
gamma = 0.6
...
Delta = []
E = []
Model = main.Equity_Debt(n_investors,w,n_corporates,n_equity,initial_value,time_to_maturity,discount_rate,face_value,beta,delta,mi,sigma,gamma,eta,noise,rho,iterationssim)
